...
function stateTagClass(s) {
  const map = {
    "Punjab":"tag-Punjab","Haryana":"tag-Haryana",
    "Uttar Pradesh":"tag-UP","Bihar":"tag-Bihar",
    "Delhi":"tag-Delhi","Assam":"tag-Assam",
    "Manipur":"tag-Manipur","Telangana":"tag-Telangana",
    "Tamil Nadu":"tag-TamilNadu","Maharashtra":"tag-Maharashtra"
  };
  return map[s] || "";
}
